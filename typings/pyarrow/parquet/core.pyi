...
class ParquetFile:
    ...
    [0,1,2,3,4,5]]
    """
    def __init__(self, source, *, metadata=..., common_metadata=..., read_dictionary=..., memory_map=..., buffer_size=..., pre_buffer=..., coerce_int96_timestamp_unit=..., decryption_properties=..., thrift_string_size_limit=..., thrift_container_size_limit=..., filesystem=...) -> None:
        ...
...
class ParquetWriter:
    __doc__ = ...
    def __init__(self, where, schema, filesystem=..., flavor=..., version=..., use_dictionary=..., compression=..., write_statistics=..., use_deprecated_int96_timestamps=..., compression_level=..., use_byte_stream_split=..., column_encoding=..., writer_engine_version=..., data_page_version=..., use_compliant_nested_type=..., encryption_properties=..., write_batch_size=..., dictionary_pagesize_limit=..., store_schema=..., write_page_index=..., **options) -> None:
        ...
...
class ParquetDataset:
    ...
    def __getnewargs_ex__(self): # -> tuple[tuple[()], dict[str, bool]]:
        ...
...
_read_table_example = ...
def read_table(source, *, columns=..., use_threads=..., metadata=..., schema=..., use_pandas_metadata=..., read_dictionary=..., memory_map=..., buffer_size=..., partitioning=..., filesystem=..., filters=..., use_legacy_dataset=..., ignore_prefixes=..., pre_buffer=..., coerce_int96_timestamp_unit=..., decryption_properties=..., thrift_string_size_limit=..., thrift_container_size_limit=...):
    ...

def read_pandas(source, columns=..., **kwargs):
    ...

def write_table(table, where, row_group_size=..., version=..., use_dictionary=..., compression=..., write_statistics=..., use_deprecated_int96_timestamps=..., coerce_timestamps=..., allow_truncated_timestamps=..., data_page_size=..., flavor=..., filesystem=..., compression_level=..., use_byte_stream_split=..., column_encoding=..., data_page_version=..., use_compliant_nested_type=..., encryption_properties=..., write_batch_size=..., dictionary_pagesize_limit=..., store_schema=..., write_page_index=..., **kwargs): # -> None:
    ...
